...
parent: Course Info
nav_order: 5
permalink: /docs/course_info/how_to_succeed/
---
...
You won’t fully grasp the concepts unless you actively type the code yourself and experience the many ways things can go wrong.
The more errors you encounter, the better! Each mistake you troubleshoot builds your understanding and sharpens your problem-solving skills.
Remember, **errors are not setbacks, they’re expected**.
Testing and debugging are vital components of any software development process, and embracing them will help you grow as a coder.

## Getting Help When Stuck

If you are stuck, there are many resources to help! Almost all coding issues you’ll encounter have been seen before.
Getting used to troubleshooting on your own with documentation, Google, Stack Overflow is an invaluable skill.
But if you can’t figure it out on your own, your classmates or the instruction team can help.

- Add your questions to [this shared Google Doc](https://docs.google.com/document/d/13i931BoEXQBp8gEUDgkXAwzEEcLg1eOLm-9fpgf05us/edit?usp=sharing). Your question can help other classmates!
- Email the teaching team if it’s something you don’t feel comfortable sharing publicly.
- Book an [office-hours]({% link docs/course_info/office_hours.md %}) slot if you need to talk in person.

If you’re really stuck, feel free to email the teaching team for help.
As with any debugging, detailing the problem is important, so for any email make sure you include the following:
...
Please keep in mind the results of an experiment shared by [Esther Shein](https://cacm.acm.org/news/the-impact-of-ai-on-computer-science-education/):
...
#### **Acknowledgement: Thanks to [Martin Fleischmann](https://martinfleischmann.net/sds/course_information/assignment.html#use-of-generative-ai) for the excerpt above.**
